...
* *Rekursive Datei- und Ordnersuche* – Sie können nun eine gesamte VMDK nach einer bestimmten Datei oder einem bestimmten Ordner durchsuchen. Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-restore.html["VMware-Workloads wiederherstellen"].
* *Verbesserte Auftragsabwicklung*: Backup and Recovery verarbeitet jetzt mehrere gleichzeitig laufende Aufträge effizienter.
