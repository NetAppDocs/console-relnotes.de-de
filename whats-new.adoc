...
.Zusätzliche Google Cloud-Berechtigungen für Cloud Volumes ONTAP
Zur Unterstützung der Cloud Volumes ONTAP -Verwaltung in Google Cloud benötigt der Console-Agent nun eine zusätzliche Berechtigung. Dem vom Console-Agenten verwendeten Dienstkonto wurde die folgende Berechtigung hinzugefügt: compute.forwardingRules.update

link:https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html#gcp-permissions-change-log["Das Änderungsprotokoll der Berechtigungen ansehen."]
