...
Weitere Informationen finden Sie unter xref:drplan-create.html#map-resources-virtual-machines-section[Erstellen eines Replikationsplans in NetApp Disaster Recovery].
