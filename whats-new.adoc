...
Weitere Informationen zum Schutz von Oracle Database-Workloads finden Sie unter  https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-oracle-protect-overview.html["Übersicht zum Schutz von Oracle-Datenbank-Workloads"].
...
.Unterstützung für Konfigurationsprüfungen für erforderliche Ports
